...
Revision ID: 7ac02d4fcd19
Revises: 8b9b76d1113f
Create Date: 2024-07-19 23:06:55.430010
...
revision = '7ac02d4fcd19'
down_revision = '8b9b76d1113f'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('interested_users', sa.JSON(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['Users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
